...
interface ResultsSnapshot { run: { id: string; title: string; code: string; status: "lobby" | "running" | "ended"; created_at: number }; questionCount: number; totalPoints: number; poolSize: number; participants: Array<Record<string, string | number | null>>; }
